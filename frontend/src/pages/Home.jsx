...
export default function Home() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#f7faf8] text-[#111c2c]">
      ...
      <header className="relative z-50 border-b border-[#edf1ee] bg-white">
        <div className="mx-auto flex h-[82px] max-w-[1350px] items-center justify-between px-6 lg:px-10">
          ...
          <a href="/" className="flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-[14px] bg-[#087443] shadow-lg shadow-[#087443]/20">
          ...
          <nav className="hidden items-center gap-9 lg:flex">
            {[
              ...
              >
                ...
                {index === 0 && (
                  <span className="absolute bottom-0 left-1/2 h-[3px] w-12 -translate-x-1/2 rounded-full bg-[#087443]" />
                )}
              </a>
            ))}
          </nav>
          ...
          <button
            ...
            className="group flex items-center gap-3 rounded-full bg-[#062f25] px-6 py-3 text-[13px] font-bold text-white transition hover:-translate-y-0.5 hover:bg-[#087443]"
          >
            Get Started
            <ArrowRight
              size={16}
      ...
      >
        {/* BACKGROUND */}
        <div className="pointer-events-none absolute -right-40 top-0 h-[650px] w-[650px] rounded-full bg-[#eef8f1]" />

        <div className="pointer-events-none absolute -left-60 bottom-0 h-[450px] w-[450px] rounded-full bg-[#f3faf5]" />
        ...
        <div className="relative mx-auto grid min-h-[610px] max-w-[1350px] items-center gap-8 px-6 py-14 lg:grid-cols-[.95fr_1.05fr] lg:px-10 lg:py-16">
          ...
          >
            ...
            <h2 className="max-w-[690px] text-[53px] font-black leading-[1.01] tracking-[-0.065em] sm:text-[65px] lg:text-[74px]">
              Scan Smart.
              <br />
              Sort Right.
              <br />
            ...
            <p className="mt-7 max-w-[540px] text-[16px] leading-7 text-[#526273]">
              ECO-SORT AI helps you identify waste in a snap and
              recommends the right bin. Together, let&apos;s build
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              <button
                onClick={startScanning}
                className="group flex items-center gap-3 rounded-full bg-[#062f25] px-7 py-4 text-[13px] font-bold text-white shadow-lg shadow-[#062f25]/15 transition hover:-translate-y-1 hover:bg-[#087443]"
              >
                Start Scanning
              ...
              <a
                href="#features"
                className="group flex items-center gap-3 rounded-full border border-[#dfe7e2] bg-white px-7 py-4 text-[13px] font-bold text-[#087443] shadow-sm transition hover:-translate-y-1 hover:border-[#afd6bc]"
              >
                Explore Features
          ...
          >
            ...
            {/* GREEN CIRCLE */}
            <div className="absolute right-[4%] top-[7%] h-[470px] w-[470px] rounded-full bg-[#dff1e4] lg:h-[510px] lg:w-[510px]" />

            <div className="absolute right-[10%] top-[14%] h-[380px] w-[380px] rounded-full bg-[#073b2d] lg:h-[420px] lg:w-[420px]" />

            {/* DOTTED RING */}
            <div className="absolute right-[1%] top-[4%] h-[510px] w-[510px] rounded-full border border-dashed border-[#a7ceb4]" />
            ...
            >
              ...
              <div className="overflow-hidden rounded-[31px] bg-white">
                ...
                <div className="px-5 pb-6 pt-4">
                  ...
                  {/* BANANA */}
                  <div className="relative mt-5 flex h-[190px] items-center justify-center overflow-hidden rounded-[18px] bg-gradient-to-br from-[#eff8ef] to-[#d8ead8]">
                  ...
                  <div className="mt-4 rounded-[17px] border border-[#e0ebe3] bg-[#f7faf7] p-4">
                    ...
                    <div className="mt-1 flex items-center justify-between">
                      ...
                      <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#e5f5e9]">
                        <Leaf
                          size={18}
                  ...
                  <button className="mt-3 flex w-full items-center justify-center gap-2 rounded-full bg-[#062f25] py-3 text-[10px] font-bold text-white">
                    Scan Another
                    <Camera size={12} />
                  </button>
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex h-11 w-11 items-center justify-center rounded-full bg-[#e8f6eb]">
                  <Leaf
                    size={20}
                ...
                <div>
                  ...
                  <p className="mt-1 text-[9px] leading-4 text-[#728079]">
                    Every right choice makes a real impact.
                  </p>
                </div>
          ...
          {stats.map((stat, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-[15px] bg-[#edf8f0]">
                  <Icon
                    size={22}
      ...
      >
        <div className="mx-auto max-w-[1200px]">
          ...
          <div className="text-center">
            ...
            <h2 className="mt-3 text-[35px] font-black tracking-[-0.05em] md:text-[43px]">
              Three simple waste categories
            </h2>

            <p className="mx-auto mt-3 max-w-[550px] text-[13px] leading-6 text-[#74827b]">
              ECO-SORT AI helps users understand where their waste
              belongs and what to do next.
            </p>
            ...
            {categories.map((category, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#eaf7ee]">
                    <Icon
                      size={19}
      ...
      >
        ...
        <div className="pointer-events-none absolute -right-40 top-0 h-[500px] w-[500px] rounded-full bg-[#0b5943]/40 blur-[90px]" />
        ...
        <div className="relative mx-auto max-w-[1200px]">
          ...
          <div className="text-center">
            ...
            <h2 className="mt-4 text-[35px] font-black tracking-[-0.05em] md:text-[45px]">
              Simple Steps,{" "}
            ...
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="mx-auto flex h-[66px] w-[66px] items-center justify-center rounded-full border border-[#1b8b58] bg-[#06372e] text-[#8de18d] shadow-[0_0_0_8px_rgba(17,113,73,.12)]">
                    <Icon size={25} />
                  </div>
                  ...
                  {index < steps.length - 1 && (
                    <div className="absolute left-[72%] top-[32px] hidden w-[55%] border-t border-dashed border-[#24774f] md:block" />
                  )}
      ...
      >
        <div className="mx-auto grid max-w-[1200px] items-center gap-14 md:grid-cols-2">
          ...
          <div>
            ...
            <h2 className="mt-4 text-[38px] font-black leading-[1.05] tracking-[-0.055em] md:text-[48px]">
            ...
            <p className="mt-5 max-w-[500px] text-[14px] leading-7 text-[#718079]">
              ECO-SORT AI turns waste identification into a simple,
              understandable action. Scan an item, understand the
              result, and sort it responsibly.
            </p>

            <button
              onClick={startScanning}
              className="mt-8 flex items-center gap-3 rounded-full bg-[#062f25] px-6 py-3.5 text-[13px] font-bold text-white transition hover:-translate-y-1 hover:bg-[#087443]"
            >
              Try ECO-SORT AI
              <ArrowRight size={16} />
            </button>
          ...
          <div className="relative rounded-[30px] bg-[#edf8f0] p-8">
            ...
            <div className="flex h-[270px] items-center justify-center">
              ...
              <div className="relative flex h-[175px] w-[175px] items-center justify-center rounded-full bg-[#d8f0de]">
                ...
                <div className="flex h-[125px] w-[125px] items-center justify-center rounded-full bg-[#087443] shadow-xl">
                  <Leaf
                    size={60}
                ...
                <div className="absolute -bottom-3 left-3 flex h-12 w-12 items-center justify-center rounded-full bg-white shadow-lg">
                  <ShieldCheck
                    size={21}
                    className="text-[#168d4c]"
                  />
      ...
      >
        <div className="mx-auto flex max-w-[1200px] flex-col justify-between gap-5 md:flex-row md:items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#087443] text-white">
              <Leaf size={18} />
            </div>
          ...
          <p className="text-[10px] text-[#87938d]">
            © 2026 ECO-SORT AI · Built for a cleaner tomorrow.
          </p>
